...
<div class="event-details">
    ...
    <!-- Bouton pour s'inscrire si l'utilisateur n'est pas déjà inscrit -->
    <?php if (!$estInscrit): ?>
        <form action="../../../backend/controller/inscription_event.php" method="post">
    ...
    <!-- Si l'événement est un "Visionnage", on affiche la section d'upload si on est inscrit ou admin -->
    ...
    <!-- Bouton de modification de l'événement si l'utilisateur est admin ou propriétaire -->
    ...
    <!-- Affichage des photos de l'utilisateur pour cet événement, si c'est un "Visionnage" -->
    <?php if ($event['type'] === 'Visionnage'): ?>
    ...
    <!-- Bouton de suppression de l'événement si l'utilisateur est admin ou propriétaire -->
    <?php if ($isAdmin || $event['uid'] == $userId): ?>
